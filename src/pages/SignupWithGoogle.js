...
import { signInWithGoogle } from "@/util/awsFuntions";
  ...
  return (
    <div className="flex flex-col items-center overflow-hidden">
      ...
      <button
        ...
        className="flex justify-center items-center w-[90%] max-w-[320px] h-[52px] border-gray-400 border hover:bg-gray-200"
      >
        <svg
          version="1.1"
